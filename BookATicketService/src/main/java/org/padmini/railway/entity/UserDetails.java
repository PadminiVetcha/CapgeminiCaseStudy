...
public class UserDetails 
{
	...
	public String toString() {
		return "UserDetails [id=" + id + ", name=" + name + ", age=" + age + ", sex=" + sex + ", address="
				+ address + ", trainNo=" + trainNo + ", trainName=" + trainName + ", startStation=" + startStation
				+ ", destStation=" + destStation + ", classType=" + classType + ", passengers=" + passengers + "]";
	}
